    ...
    <FooterTag>
      <FullW>
        <NavLinks>
          ...
          <span>|</span>
          <MShow to="/test">About-Wanderlust</MShow>
        </NavLinks>
      </FullW>
      <InnerWClf>
        <LogoFooter>{/* <LogoGray /> */}</LogoFooter>
        <Fl>
          <FooterStrong>(주) Wanderlust</FooterStrong>
          <FooterUl>
            <FooterLi>대표이사 : 구희연</FooterLi>
            {/* <FooterLi>서울특별시 마포구 동교로 19길 12</FooterLi>
            <FooterLi>사업자 등록번호 : 107-87-83297</FooterLi>
            <FooterLi>통신판매업신고 : 2015-서울마포-0440</FooterLi> */}
          </FooterUl>
          <NtFix1>
            Wanderlust는 통신판매중개자이며 통신판매의 당사자가 아닙니다.
            <br />
            따라서 Wanderlust는 상품 거래정보 및 거래에 대하여 책임을 지지
            않습니다.
            <Copyright>Copyright © 2023 Wanderlust All right reserved.</Copyright>
          </NtFix1>
        </Fl>
        <Fl>
          ...
          <NtFix1>
            이용 중 궁금하신 점이 있으신가요?
            <br />
            메일 또는 플러스친구 `Wanderlust`로 연락해주세요.
            <br />
            최선을 다해 도와드리겠습니다.
          </NtFix1>
        </Fl>
